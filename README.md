...
The module currently exports completed PSRP connectivity checks and direct `-ComputerName` command execution with optional captured-output artifacts.
